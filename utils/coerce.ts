...
export default function coerce<
  T extends GenericEnum,
  DefaultValue extends T[keyof T] | undefined
>(obj: T, value: any, defaultValue?: DefaultValue): T[keyof T] | DefaultValue {
